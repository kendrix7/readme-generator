...
function generateMarkdown(userResponses, userInfo) {
  ...
  const optionalSections = mrkdwnCreationHelper.createOptionalSections(
    userResponses
  );
  const licenseSection = mrkdwnCreationHelper.createLicenceSection(
    userResponses
  );
  const questionsSection = mrkdwnCreationHelper.createQuestionsSection(
    userResponses,
    userInfo
  );
